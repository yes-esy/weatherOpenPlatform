...
int main(int argc, char *argv[])
{
    if (argc < 3)
    {
        ...
        /// project/dataOpenPlatform/tools/cpp/procctl.cpp
        printf("Example:/project/dataOpenPlatform/tools/bin/procctl 10 /usr/bin/tar zcvf /tmp/tmp.tgz /usr/include\n");
        printf("Example:/project/dataOpenPlatform/tools/bin/procctl 60 /project/idc/bin/crtsurfdata /project/idc/ini/stcode.ini /tmp/idc/surfdata /log/idc/crtsurfdata.log csv,xml,json\n");
